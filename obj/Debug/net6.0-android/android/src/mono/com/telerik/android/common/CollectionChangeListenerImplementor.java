...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Android.Common.ICollectionChangeListenerImplementor, Telerik.Android.Common", CollectionChangeListenerImplementor.class, __md_methods);
	}
	...
	public CollectionChangeListenerImplementor ()
	{
		...
		if (getClass () == CollectionChangeListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Android.Common.ICollectionChangeListenerImplementor, Telerik.Android.Common", "", this, new java.lang.Object[] {  });
	}
