...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.Autocomplete.ITokenDeselectedListenerImplementor, Telerik.Android.Input", TokenDeselectedListenerImplementor.class, __md_methods);
	}
	...
	public TokenDeselectedListenerImplementor ()
	{
		...
		if (getClass () == TokenDeselectedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.Autocomplete.ITokenDeselectedListenerImplementor, Telerik.Android.Input", "", this, new java.lang.Object[] {  });
	}
