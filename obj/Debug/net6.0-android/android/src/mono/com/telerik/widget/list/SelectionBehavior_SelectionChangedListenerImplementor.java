...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.List.SelectionBehavior+ISelectionChangedListenerImplementor, Telerik.Android.List", SelectionBehavior_SelectionChangedListenerImplementor.class, __md_methods);
	}
	...
	public SelectionBehavior_SelectionChangedListenerImplementor ()
	{
		...
		if (getClass () == SelectionBehavior_SelectionChangedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.List.SelectionBehavior+ISelectionChangedListenerImplementor, Telerik.Android.List", "", this, new java.lang.Object[] {  });
	}
