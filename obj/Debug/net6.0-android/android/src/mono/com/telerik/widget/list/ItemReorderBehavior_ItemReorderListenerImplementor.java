...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.List.ItemReorderBehavior+IItemReorderListenerImplementor, Telerik.Android.List", ItemReorderBehavior_ItemReorderListenerImplementor.class, __md_methods);
	}
	...
	public ItemReorderBehavior_ItemReorderListenerImplementor ()
	{
		...
		if (getClass () == ItemReorderBehavior_ItemReorderListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.List.ItemReorderBehavior+IItemReorderListenerImplementor, Telerik.Android.List", "", this, new java.lang.Object[] {  });
	}
