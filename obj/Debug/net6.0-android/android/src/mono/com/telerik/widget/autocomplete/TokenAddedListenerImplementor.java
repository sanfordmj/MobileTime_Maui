...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.Autocomplete.ITokenAddedListenerImplementor, Telerik.Android.Input", TokenAddedListenerImplementor.class, __md_methods);
	}
	...
	public TokenAddedListenerImplementor ()
	{
		...
		if (getClass () == TokenAddedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.Autocomplete.ITokenAddedListenerImplementor, Telerik.Android.Input", "", this, new java.lang.Object[] {  });
	}
