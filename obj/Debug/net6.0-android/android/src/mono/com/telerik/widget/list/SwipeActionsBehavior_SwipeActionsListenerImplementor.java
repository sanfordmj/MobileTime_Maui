...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onExecuteFinished:(Lcom/telerik/widget/list/SwipeActionsBehavior$SwipeActionEvent;)V:GetOnExecuteFinished_Lcom_telerik_widget_list_SwipeActionsBehavior_SwipeActionEvent_Handler:Com.Telerik.Widget.List.SwipeActionsBehavior/ISwipeActionsListenerInvoker, Telerik.Android.List\n" +
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.List.SwipeActionsBehavior+ISwipeActionsListenerImplementor, Telerik.Android.List", SwipeActionsBehavior_SwipeActionsListenerImplementor.class, __md_methods);
	}
	...
	public SwipeActionsBehavior_SwipeActionsListenerImplementor ()
	{
		...
		if (getClass () == SwipeActionsBehavior_SwipeActionsListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.List.SwipeActionsBehavior+ISwipeActionsListenerImplementor, Telerik.Android.List", "", this, new java.lang.Object[] {  });
	}
