...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.Autocomplete.ITokenRemovedListenerImplementor, Telerik.Android.Input", TokenRemovedListenerImplementor.class, __md_methods);
	}
	...
	public TokenRemovedListenerImplementor ()
	{
		...
		if (getClass () == TokenRemovedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.Autocomplete.ITokenRemovedListenerImplementor, Telerik.Android.Input", "", this, new java.lang.Object[] {  });
	}
