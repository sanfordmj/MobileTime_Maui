...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.List.SwipeRefreshBehavior+ISwipeRefreshListenerImplementor, Telerik.Android.List", SwipeRefreshBehavior_SwipeRefreshListenerImplementor.class, __md_methods);
	}
	...
	public SwipeRefreshBehavior_SwipeRefreshListenerImplementor ()
	{
		...
		if (getClass () == SwipeRefreshBehavior_SwipeRefreshListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.List.SwipeRefreshBehavior+ISwipeRefreshListenerImplementor, Telerik.Android.List", "", this, new java.lang.Object[] {  });
	}
