...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.Chart.Visualization.Behaviors.ITooltipContextNeededListenerImplementor, Telerik.Android.Chart", TooltipContextNeededListenerImplementor.class, __md_methods);
	}
	...
	public TooltipContextNeededListenerImplementor ()
	{
		...
		if (getClass () == TooltipContextNeededListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.Chart.Visualization.Behaviors.ITooltipContextNeededListenerImplementor, Telerik.Android.Chart", "", this, new java.lang.Object[] {  });
	}
