...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Android.Primitives.Widget.Sidedrawer.IDrawerChangeListenerImplementor, Telerik.Android.Primitives", DrawerChangeListenerImplementor.class, __md_methods);
	}
	...
	public DrawerChangeListenerImplementor ()
	{
		...
		if (getClass () == DrawerChangeListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Android.Primitives.Widget.Sidedrawer.IDrawerChangeListenerImplementor, Telerik.Android.Primitives", "", this, new java.lang.Object[] {  });
	}
