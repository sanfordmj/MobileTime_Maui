...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Telerik.Widget.Chart.Engine.Databinding.Datasources.IDataBindingListenerImplementor, Telerik.Android.Chart", DataBindingListenerImplementor.class, __md_methods);
	}
	...
	public DataBindingListenerImplementor ()
	{
		...
		if (getClass () == DataBindingListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Telerik.Widget.Chart.Engine.Databinding.Datasources.IDataBindingListenerImplementor, Telerik.Android.Chart", "", this, new java.lang.Object[] {  });
	}
