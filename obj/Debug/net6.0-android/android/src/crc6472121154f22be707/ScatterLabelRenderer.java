...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.XamarinForms.ChartRenderer.Android.ScatterLabelRenderer, Telerik.Maui.Controls.Compatibility", ScatterLabelRenderer.class, __md_methods);
	}
	...
	public ScatterLabelRenderer (com.telerik.widget.chart.visualization.common.ChartSeries p0)
	{
		...
		if (getClass () == ScatterLabelRenderer.class)
			mono.android.TypeManager.Activate ("Telerik.XamarinForms.ChartRenderer.Android.ScatterLabelRenderer, Telerik.Maui.Controls.Compatibility", "Com.Telerik.Widget.Chart.Visualization.Common.ChartSeries, Telerik.Android.Chart", this, new java.lang.Object[] { p0 });
	}
