...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.XamarinForms.ChartRenderer.Android.PieLabelRenderer, Telerik.Maui.Controls.Compatibility", PieLabelRenderer.class, __md_methods);
	}
	...
	public PieLabelRenderer (com.telerik.widget.chart.visualization.pieChart.PieSeries p0)
	{
		...
		if (getClass () == PieLabelRenderer.class)
			mono.android.TypeManager.Activate ("Telerik.XamarinForms.ChartRenderer.Android.PieLabelRenderer, Telerik.Maui.Controls.Compatibility", "Com.Telerik.Widget.Chart.Visualization.PieChart.PieSeries, Telerik.Android.Chart", this, new java.lang.Object[] { p0 });
	}
